...
export default function RootRedirectPage() {
  ...
  // The 'replace' option is implicit with redirect, ensuring the history stack is clean.
  redirect('/auth/login');

  // This component will not be rendered as the redirect happens before rendering.
  return null;
}
// //app/(main)/page.tsx
